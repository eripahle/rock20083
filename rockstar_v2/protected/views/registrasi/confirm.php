...
<div style="min-width:500px;">
	...
	<div class="col-md-7">
		<div class="panel" style="min-width=500px;">
			<div class="panel-heading text-center" style="background-color:#111;color:#fff;">CONFIRM</div>   
			<div class="panel-body">
				...
				<?php  foreach(Yii::app()->user->getFlashes() as $key => $message) { ?>
						...
						<?php } ?>
						<br>
						<font color="red"> * Data Virtual ID dan Password Akan Dikirim ke Email Anda</font>
						<a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/site/login" class="btn btn-success">OK</a>
