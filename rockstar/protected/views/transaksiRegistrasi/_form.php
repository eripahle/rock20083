...
<div style="min-width:500px;">
	...
	<div class="col-md-7" >
		<div class="panel" style="min-width=500px;">
			<div class="panel-heading text-center" style="background-color:#111;color:#fff;">REGISTRASI</div>   
	...
	// See class documentation of CActiveForm for details on this.
								...
								<fieldset>
									...
									<div class="row">
										<?php echo $form->labelEx($model_user,'NOMER_SAKTI'); ?>
										<?php echo $form->textField($model_user,'NOMER_SAKTI',array(
											'size'=>30,'maxlength'=>30,'style' => 'width: 60%; border-radius: 0px;','class'=>'form-control')
											); ?>
											<?php echo $form->error($model_user,'NOMER_SAKTI'); ?>
											<!-- <input type="text" name="User[NOMER_SAKTI]" size="30" maxlength="30"> -->
										</div>
										<div class="row">
											<?php echo $form->labelEx($model_user,'PASSWORD'); ?>
											<?php echo $form->textField($model_user,'PASSWORD',array(
											'size'=>30,'maxlength'=>30,'readonly'=>true,'style' => 'width: 40%; border-radius: 0px;','class'=>'form-control')); ?>
											<?php echo $form->error($model_user,'PASSWORD'); ?>
											<span class="btn btn-danger" id="refresh_pass"> Refresh </span>
										</div>
									</fieldset>
									<br>
									<fieldset>
