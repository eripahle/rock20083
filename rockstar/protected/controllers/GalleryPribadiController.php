...
class GalleryPribadiController extends Controller
{
	/**
	...
	{
		$model=new GalleryPribadi('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['GalleryPribadi']))
			$model->attributes=$_GET['GalleryPribadi'];
	 ...
	 * @param GalleryPribadi $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='gallery-pribadi-form')
		{
