...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 03, 2015 at 02:41 PM
...
CREATE TABLE `transaksi_registrasi` (
  ...
  `VALIDASI_UPLOAD` char(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `transaksi_registrasi` (`ID_REGISTRASI`, `ID_FANBASE`, `NAMA_LENGKAP`, `TEMPAT`, `TANGGAL`, `NEGARA`, `PROVINSI`, `KOTA`, `ALAMAT`, `KODE_POS`, `NO_TELP`, `EMAIL`, `TWITTER`, `NAMA_IBU`, `NAMA_AYAH`, `NO_SAKTI`, `CORP`, `VAD`, `STATUS_REKONSILIASI`, `STATUS_RELEASE`, `VAD_REKON`, `VALIDASI_UPLOAD`) VALUES
(1, 1, 'Ayu Laras Wati', 'Bandung', '1994-11-02', 'Indonesia', 'Jawa Barat', 'Bandung', 'Jl.testing', '40238', '08237274231', 'ayu_laras@yahoo.com', 'jajang_rc', 'Sutarti', 'Sutejo', '6100000000000000', 'BANDUNG', '8118162021001130', '0', '0', '', '0'),
(2, 1, 'Winaya Novrizka', 'Bandung', '1995-11-10', 'Indonesia', 'Jawa Barat', 'Bandung', 'Jl.Raya Batujajar', '40216', '08732773223', 'Winaya@yahoo.com', '', '', '', '6110000000000000', 'Bandung', '8118162061000000', '0', '0', '', '0'),
(3, 1, 'Saidah Erva', 'Jakarta', '1994-10-10', 'Indonesia', 'Jakarta', 'Jakarta', 'Jl.Jakarta', '40216', '0872732774221', 'unknown@yahoo.com', '', '', '', '6120000000000000', 'Jakarta', '8118162021000020', '0', '0', '', '0'),
(4, 1, 'Etdah', 'Bandung', '2015-11-01', 'Indonesia', 'Jawa Barat', 'Bandung', 'jl kampang', '40216', '089323928', '', '', '', '', '6130000000000000', 'BANDUNG', '8118162021001110', '0', '0', '', '0');
