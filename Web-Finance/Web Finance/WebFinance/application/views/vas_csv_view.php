	...
	<form action="<?php echo base_url('Vas_csv/delete_multiple'); ?>" method="post">
		<table border="0"  id="myTable" cellspacing="0" width = '1024'>
			...
			<tbody>
				...
				$query = $this->db->query('SELECT id_registrasi, no_sakti, nama_lengkap,status_rekonsiliasi FROM transaksi_registrasi WHERE status_rekonsiliasi="1" AND status_release = "0"');
