	...
	<form action="<?php echo base_url('Validasi_release/delete_multiple'); ?>" method="post">
		<table border="0"  id="myTable" cellspacing="0" >
			...
			<tbody>
        		...
        		$query = $this->db->query('SELECT id_registrasi,VAD,VAD_rekon, no_sakti, nama_lengkap FROM transaksi_registrasi WHERE status_rekonsiliasi="3" AND status_release = "0"');
